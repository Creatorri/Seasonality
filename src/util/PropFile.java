...
public class PropFile {
     ...
     * @param props
     */
    public PropFile(String dir, String[] props) {
        (new File("WhatsinSeasonNow")).mkdirs();
        rp = new File("WhatsinSeasonNow" + File.separator + dir);
        this.props = props;
     ...
     * @param data
     */
    public PropFile(String dir, String[] props, String[] data) {
        rp = new File(dir);
        this.props = props;
        out = new String[props.length];
        try {
